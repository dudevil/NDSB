...
if __name__ == "__main__":
    ...
    dsl = DataSetLoader(rng=rng, img_size=96, n_epochs=n_epochs, parallel=True, pad=True)
    ...
    slice = SliceLayer(x.reshape((batch_size, 1, 96, 96)), (batch_size, 1, 96, 96))
    ...
    layer0 = ConvPoolLayer(
        rng,
        input=slice.output,
        image_shape=(new_batch_size, 1, 48, 48),
    ...
    layer1 = ConvPoolLayer(
        rng,
        input=layer0.output,
        image_shape=(new_batch_size, nkerns[0], 22, 22),
    ...
    layer2 = ConvPoolLayer(
        rng,
        input=layer2_input,
        image_shape=(new_batch_size, nkerns[1], 9, 9),
    ...
    layer7 = ConvPoolLayer(
        rng,
        input=layer2.output,
        image_shape=(new_batch_size, nkerns[2], 6, 6),
    ...
    dout1 = DropOutLayer(rng, merge.output, merge.output_shape, dropout_active)
    ...
    # add dropout at 0.5 rate
    dout3 = DropOutLayer(rng, maxlayer2.output, maxlayer2.output_shape, dropout_active)
    ...
    numpy.save("data/tidy/49_4cl_dense2048_norm_morefilters.npy", results)
